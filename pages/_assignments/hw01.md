...
### 1. Implement the following GET routes (12 Points)
...
{:.checkbox-list}
* __[18 Pts]__ You have implemented all of the required API endpoints listed in Part 3.
* You have create a __private__ repository and checked in all of your code to main.
* __[2 Pts]__ You have deployed your code to Heroku.
