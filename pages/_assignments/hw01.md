...
{:#routes}
## Part 3: Writing the API (20 Points)
...
### 1. Implement the following GET routes (14 Points)
...
### 2. Implement POST, PATCH, and DELETE routes (6 Points)
...
{:.checkbox-list}
* You have implemented all of the required API endpoints listed in Part 3.
* You have create a __private__ repository and checked in all of your code to main.
* You have deployed your code to Heroku.
* You have verified that all of the tests pass with the Heroku instance of your code. To verify this:
   * Open the `test/util/testUtil.js` folder
   * Edit the endpoint so that instead of pointing to `http://localhost:8081` it points to your Heroku instance (see video).
   * run the Mocha tests: `npm test`

When you're done, you should submit the following to Canvas:

1. Your completed `routes.js` file.
