...
* [L10: Intro to CSS & Layouts](../lectures/lecture10)
...
Navigate to: <a href="http://localhost:8081/editor.html" target="_blank">http://localhost:8081/editor.html</a> to preview the current state of this page. Then, open `editor.html` and `scripts/editor.js` in your code editor and complete the following tasks:

### 1. Display all of the doctors (1 Points)
...
### 2. Display individual doctor and associated companions (3 Points)
When the user clicks on one of the doctors, display the following:
* A panel showing the doctor's name, picture, and seasons (1.5 points).
* A panel showing all of the companions that traveled with the doctor (1.5 points).

Note that this will require 2 fetch requests to be issued simultaneously: one to `/doctors/:id` and one to `/doctors/:id/companions`. Demo video below:
...
## Part 5: Deploy your app to Heroku (2 Points)
...
<table>
    ...
    <tr>
        <th colspan="3"><h4>Part 2 (18 Points)</h4></th>
    </tr>
    <tr>
        <th>1 pt</th>
        <td>Doctor List</td>
    ...
    <tr>
        ...
        When you click any of the doctors:
            <ul>
                <li>Details about the doctor are displayed (1.5 pts)</li>
                <li>Details about the doctor's corresponding companions are displayed (1.5 pts)</li>
            </ul> 
        </td>
    </tr>
    <tr>
        ...
        <td> 
            <ul>
                ...
                <li>A successful post hides the detail panel an redraws the left-hand panel (1 pt). </li>
    ...
    <tr>
        ...
        <td>
            <ul>
                <li>Asks the user if they really want to delete. </li>
    ...
    <tr>
        <th colspan="3"><h4>Part 4 (2 Points)</h4></th>
    </tr>
    <tr>
        <th>2 pts</th>
        <td>Heroku Server</td>
