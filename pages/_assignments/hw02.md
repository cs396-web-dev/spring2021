...
Give the aforementioned file changes, please re-download hw02-cs396.zip file (below) and unzip it. 
...
Then, complete one of the following sets of tasks (up to you):
